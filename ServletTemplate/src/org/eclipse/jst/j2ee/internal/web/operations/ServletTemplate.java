...
public class ServletTemplate
{
  ...
  protected final String TEXT_44 = NL + NL + "\tpublic void init(ServletConfig config) throws ServletException {" + NL + "\t}";
  protected final String TEXT_45 = NL + NL + "\tpublic void destroy() {" + NL + "\t}";
  protected final String TEXT_46 = NL + NL + "\tpublic ServletConfig getServletConfig() {" + NL + "\t\treturn null;" + NL + "\t}";
  protected final String TEXT_47 = NL + NL + "\tpublic String getServletInfo() {" + NL + "\t\treturn null; " + NL + "\t}";
  protected final String TEXT_48 = NL + NL + "\tpublic void service(ServletRequest request, ServletResponse response) throws ServletException, IOException {" + NL + "\t}";
  protected final String TEXT_49 = NL + NL + "\tprotected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {" + NL + "\t}";
  protected final String TEXT_50 = NL + NL + "\tprotected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {" + NL + "\t\t// 第一步，接收参数" + NL + "\t\tString uid = request.getParameter(\"\");" + NL + "\t\t// 第二步，处理业务" + NL + "\t\tString s = null;" + NL + "\t\t// 第三步，输出" + NL + "\t\tresponse.setCharacterEncoding(\"utf-8\");" + NL + "\t\tresponse.setContentType(\"text/html\");" + NL + "\t\t// 如果使用lombok的 @Cleanup: 将自动在最后调用 close() 关闭可关闭流" + NL + "\t\tPrintWriter out = response.getWriter();" + NL + "" + NL + "\t\tout.println(s);" + NL + "\t\tout.flush();" + NL + "\t\tout.close();" + NL + "\t}";
  protected final String TEXT_51 = NL + NL + "\tprotected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {";
  protected final String TEXT_52 = NL + "\t\t// 第一步，接收参数，以下可能用到阿里巴巴的 fastjson 组件，必须用到工具类：RequestToBean" + NL + "\t\t//方法一：用 axios 的 POST 提交 JSON 格式的数据，所以使用 fastjson 转换成 javabean 对象" + NL + "//\t\tGood good = JSON.parseObject(RequestToBean.getRequestPostStr(request), Good.class);" + NL + "\t\t//方法二：用 mui 的 POST 方式提交正常接收" + NL + "//\t\tGood good = RequestToBean.getBeanToRequest(request, Good.class);" + NL + "\t\t// 第二步，处理业务" + NL + "\t\tString s = null;" + NL + "\t\t// 第三步，输出" + NL + "\t\tresponse.setCharacterEncoding(\"utf-8\");" + NL + "\t\tresponse.setContentType(\"text/html\");" + NL + "\t\t// 如果使用lombok的 @Cleanup: 将自动在最后调用 close() 关闭可关闭流" + NL + "\t\tPrintWriter out = response.getWriter();" + NL + "" + NL + "\t\tout.println(s);" + NL + "\t\tout.flush();" + NL + "\t\tout.close();";
  protected final String TEXT_53 = NL + "\t}";
  protected final String TEXT_54 = NL + NL + "\tprotected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {" + NL + "\t}";
  protected final String TEXT_55 = NL + NL + "\tprotected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {" + NL + "\t}";
  protected final String TEXT_56 = NL + NL + "\tprotected void doHead(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {" + NL + "\t}";
  protected final String TEXT_57 = NL + NL + "\tprotected void doOptions(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {" + NL + "\t}";
  protected final String TEXT_58 = NL + NL + "\tprotected void doTrace(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {" + NL + "\t}";
